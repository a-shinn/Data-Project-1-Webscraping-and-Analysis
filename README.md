...
The notebook files that I used for webscraping and data analysis are in the main folder, final visualizations are located in the visualizations_final folder, and datasets and files used are in the src folder.
